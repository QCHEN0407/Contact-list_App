...
function ConfirmDelete({confirmDelete, cancelDelete, contact}) {
    ...
    return (
        <div id="modal">
            ...
            <div id="modal-content">
                ...
                <button name="confirmDeleteContactButton" className="deleteButton" onClick={() => {confirmDelete(contact)}}>Confirm</button>
            </div>
